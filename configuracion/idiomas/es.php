...
return [
    ...
    'admin.ia.descripcion' => 'Gestión básica de la base de conocimiento del sistema de diagnóstico asistido de TorqHub.',
    'admin.ia.volver' => 'Volver al panel de administración',

    'admin.ia.resumen.titulo' => 'Resumen de la base de conocimiento',
    'admin.ia.resumen.texto' => 'El sistema experto carga causas mecánicas y palabras clave desde base de datos. Si la carga falla, el motor mantiene un fallback interno para no romper el chat de diagnóstico.',
    'admin.ia.resumen.causas' => 'causas registradas',
    'admin.ia.resumen.keywords' => 'keywords registradas',

    'admin.ia.sin_causas' => 'No hay causas registradas en la base de conocimiento',
    'admin.ia.sin_keywords' => 'Sin keywords',

    'admin.ia.tabla.id' => 'ID',
    'admin.ia.tabla.causa' => 'Causa',
    'admin.ia.tabla.recomendacion' => 'Recomendación',
    'admin.ia.tabla.estado' => 'Estado',
    'admin.ia.tabla.keywords' => 'Keywords',
    'admin.ia.tabla.fecha' => 'Fecha de creación',

    'admin.ia.estado.activa' => 'Activa',
    'admin.ia.estado.inactiva' => 'Inactiva',

    'admin.ia.defensa.titulo' => 'Defensa técnica',
    'admin.ia.defensa.texto' => 'Esta migración convierte el diagnóstico en una base de conocimiento persistente sin cambiar la experiencia del usuario ni depender de servicios externos.',
    'admin.ia.defensa.aviso' => 'Decisión defendible: el sistema sigue siendo propio, gratuito, privado y mantenible desde base de datos.',
