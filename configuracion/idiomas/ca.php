...
return [
    ...
    'admin.ia.descripcion' => 'Resum tècnic del sistema de diagnòstic assistit de TorqHub.',
    'admin.ia.volver' => 'Tornar al panell d’administració',

    'admin.ia.estado_actual.titulo' => 'Estat actual',
    'admin.ia.estado_actual.texto' => 'El mòdul de diagnòstic ja està implementat com un sistema expert propi basat en regles, paraules clau i recomanacions.',
    'admin.ia.estado_actual.punto_1' => 'No utilitza serveis externs de pagament',
    'admin.ia.estado_actual.punto_2' => 'No envia símptomes dels usuaris a tercers',
    'admin.ia.estado_actual.punto_3' => 'Funciona mitjançant causes, keywords i rànquing de coincidències',
    'admin.ia.estado_actual.punto_4' => 'Està integrat amb una interfície tipus xat mitjançant AJAX',

    'admin.ia.funcionamiento.titulo' => 'Funcionament tècnic',
    'admin.ia.funcionamiento.paso_1' => 'L’usuari escriu els símptomes del vehicle al xat de diagnòstic.',
    'admin.ia.funcionamiento.paso_2' => 'El backend normalitza el text per comparar millor les paraules introduïdes.',
    'admin.ia.funcionamiento.paso_3' => 'El motor busca coincidències amb les keywords definides a la base de coneixement interna.',
    'admin.ia.funcionamiento.paso_4' => 'Cada causa rep una puntuació segons les coincidències trobades.',
    'admin.ia.funcionamiento.paso_5' => 'El sistema retorna les causes més probables amb una recomanació orientativa.',

    'admin.ia.decision.titulo' => 'Decisió d’implementació',
    'admin.ia.decision.texto' => 'Actualment es manté el motor basat en arrays interns perquè ja és funcional, estable i suficient per al lliurament del projecte.',
    'admin.ia.decision.defensa' => 'Decisió defensable: es prioritza l’estabilitat abans que migrar una funcionalitat ja acabada a base de dades en la fase final del projecte.',

    'admin.ia.futuro.titulo' => 'Millora futura plantejada',
    'admin.ia.futuro.texto' => 'L’arquitectura actual permet migrar la base de coneixement a taules de base de dades sense canviar la interfície de l’usuari.',
    'admin.ia.futuro.tabla' => 'Taula',
    'admin.ia.futuro.descripcion' => 'Descripció',
    'admin.ia.futuro.ia_causas' => 'Desaria les causes mecàniques, el títol, l’explicació, la recomanació i l’estat actiu.',
    'admin.ia.futuro.ia_keywords' => 'Desaria les paraules clau associades a cada causa, permetent editar-les des del panell admin.',

    'admin.ia.conclusion.titulo' => 'Conclusió',
    'admin.ia.conclusion.texto' => 'Per a aquesta versió, el sistema expert queda documentat com a funcional i escalable. La gestió editable des de base de dades es planteja com a millora posterior.',
