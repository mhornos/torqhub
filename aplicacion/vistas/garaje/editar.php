...
<body>
    <main class="garaje-formulario-contenedor">
        ...
        <form
            ...
            class="formulario-garaje-validado garaje-formulario-panel"
            ...
            <div class="garaje-formulario-campo garaje-formulario-campo--ancho-completo">
                <label for="vin"><?= htmlspecialchars(t('garaje.form.vin')) ?>:</label>

                <div class="garaje-formulario-vin">
                    <input
                        type="text"
                        name="vin"
                        id="vin"
                ...
                <small class="garaje-formulario-ayuda">
                    <?= htmlspecialchars(t('garaje.form.vin_ayuda_editar')) ?>.
                </small>
            ...
            <div class="garaje-formulario-campo garaje-formulario-campo--ancho-completo">
                ...
                <input
                    ...
                    multiple>
                <small class="garaje-formulario-ayuda">
                    <?= htmlspecialchars(t('garaje.form.cambiar_imagen_ayuda')) ?>.
                </small>
            </div>

            <?php if (!empty($vehiculo['imagen'])): ?>
                <section class="garaje-formulario-imagen-actual garaje-formulario-campo--ancho-completo">
                    <h2><?= htmlspecialchars(t('garaje.form.imagen_actual')) ?></h2>
