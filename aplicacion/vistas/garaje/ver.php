...
<body>
    ...
    <main class="garaje-detalle-contenedor">
        <header class="garaje-detalle-encabezado">
        ...
        <section class="detalle-vehiculo-cabecera">
            ...
            <div class="detalle-vehiculo-columna-principal">
                <section class="detalle-vehiculo-bloque detalle-vehiculo-bloque-principal">
                    <h2>
                ...
                <section class="detalle-vehiculo-bloque detalle-vehiculo-bloque-estadisticas">
        ...
        <section class="garaje-detalle-historial">
            <div class="garaje-detalle-historial__cabecera">
                <h2><?= htmlspecialchars(t('garaje.historial.titulo')) ?></h2>

                <div class="garaje-detalle-historial__acciones">
